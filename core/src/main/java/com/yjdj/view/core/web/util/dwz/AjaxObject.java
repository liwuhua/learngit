 ...
 * Filename:		com.yjdj.view.core.web.util.dwz.AjaxObject.java
 * Class:			AjaxObject
 * Date:			2012-6-8
...
package com.yjdj.view.core.web.util.dwz;
...
public class AjaxObject {
	...
	private String rel = "";  //rel 是刷新id：用于定义一个页面的标识，用于删除添加修改，找到列表页面刷新。
