...
import com.yjdj.view.core.service.IReportServiceFS30;
...
public class ReportServiceImpFS30 implements IReportServiceFS30 {
    @Autowired
...
//计算账龄日期
        ...
        List<THM_FS07> list2 = iReportMapperFS07.selectDataTrue_07(queryBean.getCompCodeValue(), queryBean.getKunnrValue(), queryBean.getKunnrValue(),queryBean.getDateYearMonthStart(),queryBean.getDateYearMonthEnd(),start1, end1, date1, date2, date3, date4, date5, date6, date7, date8,date9,date10,date11,date12,date13,queryBean.getStartitem(),queryBean.getPageitem(),flag);
      //  List<THM_FS07> list2 = iReportMapperFS07.selectDataTrue_07(queryBean.getCompCodeValue(), queryBean.getKunnrValue(), queryBean.getKunnrValue(), start1, end1, date1, date2, date3, date4, date5, date6, date7, date8,date9,date10,date11,date12,date13,queryBean.getStartitem(),queryBean.getPageitem(),flag);
...
//        }
	...
	public HashMap<String, String> accountAge(String date) {
		...
		try {
		String date0 = DateUtils.getDateStr(date);
        String date1 = DateUtils.getDayBeforeStr(date0, 0);
        String date2 = DateUtils.getDayBeforeStr(date0, 180);
        String date3 = DateUtils.getDayBeforeStr(date0, 181);
        String date4 = DateUtils.getDayBeforeStr(date0, 360);
        String date5 = DateUtils.getDayBeforeStr(date0, 361);
        String date6 = DateUtils.getDayBeforeStr(date0, 720);
        String date7 = DateUtils.getDayBeforeStr(date0, 721);
        String date8 = DateUtils.getDayBeforeStr(date0, 1080);
        String date9 = DateUtils.getDayBeforeStr(date0, 1081);
        String date10 = DateUtils.getDayBeforeStr(date0, 1440);
        String date11 = DateUtils.getDayBeforeStr(date0, 1441);
        String date12 = DateUtils.getDayBeforeStr(date0, 1800);
        String date13 = DateUtils.getDayBeforeStr(date0, 1801);
