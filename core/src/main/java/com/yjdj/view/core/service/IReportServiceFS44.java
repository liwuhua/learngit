...
public interface IReportServiceFS44 {
     
	 public String getListFs44(QueryBean queryBean,List<String> palantList) throws JsonProcessingException,DataAccessException;
