...
import com.yjdj.view.core.mapper.IReportMapperFS44;
...
public class ReportServiceImpFS44 implements IReportServiceFS44{

    @Autowired
    private IReportMapperFS44 ireportmapperfs44;
    
    @Autowired
    private GenericMapper genericMapper;
    private final Logger log = Logger.getLogger(ReportServiceImpFS44.class);

    /**
     * 查询数据
     */
    @Override
    public String getListFs44(QueryBean queryBean,List<String> plantList) throws JsonProcessingException,DataAccessException{
       ...
       // 报告日期 DELIDATE  基本开始日期  endTime  startTime   必选的  其他不适必选的
        	if(StringUtils.isNotBlank(delidate)){
        		...
        		HashMap resultMap=new HashMap<>(); 
 				 List<HashMap> MatnrpullCompar = ireportmapperfs44.getMatnrpullCompar(paraMap);
