 ...
 * Filename:		com.yjdj.view.core.web.shiro.BaseFormAuthenticationFilter.java
...
public class BaseFormAuthenticationFilter extends FormAuthenticationFilter {
	 ...
	 * @param mappedValue
	 * @return  
	 * @see org.apache.shiro.web.filter.authc.AuthenticatingFilter#isAccessAllowed(javax.servlet.ServletRequest, javax.servlet.ServletResponse, Object)
	 */
    @Override
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject,
		...
		if (!"XMLHttpRequest".equalsIgnoreCase(httpServletRequest.getHeader("X-Requested-With")) 
			...
			System.out.print(httpServletRequest.getContextPath() + this.getSuccessUrl());
