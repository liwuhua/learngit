...
var search5=new multiSearch4($(".btn5"),"reportFS50/produccode",0,10);//产品编号
var search6=new multiSearch4($(".btn6"),"reportFS50/motorcode",0,10);//机车编号
var search7=new multiSearch3($(".btn7"),"reportFS50/defalocation",null,null);//故障部位
var search8=new multiSearch3($(".btn8"),"reportFS50/accitype",null,null);//事故类别
var search9=new multiSearch3($(".btn9"),"reportFS50/severity",null,null);//严重度
var search10=new multiSearch3($(".btn10"),"reportFS50/productlife",null,null);//产品寿命阶段
var search13=new multiSearch3($(".btn13"),"reportFS50/tvendor",null,null);//供应商
...
$(".ch-kp-fifty-one .t_r_content").height((heights - heights_f - 130) + "px");
//点击收起按钮
$(".retract").off("click").on("click", function () {
    if ($(".container form").css("display") == "block") {
        ...
        $(this).text("展开  ∨");
        var heights = $(window).height();
        $(".ch-kp-fifty-one .t_r_content").animate({
...
$("#submit").off("click").on("click", function () {
    ...
    $("#show").text("数据正在加载中");
    //$(".hideCol").click();
    var array1 = [], array2 = [], array3 = [],array4 = [],array5 = [],array6 = [],array7 = [],array8 = [],array9 = [],array10 = [],array11 = [],array12 = [],array13 = [];
    if ($(".xxbh").val() != "") {
    ...
    if(parseInt(txt1)>parseInt(txt2)||parseInt(txt3)>parseInt(txt4)){
        ...
        $(".export").on("click", function () {
            ...
            downloadFile(reportJson, ctx + "/crrc/reportFS50/downloadFile_01");
        });
        $.ajax({
            url: ctx + "/crrc/reportFS50/result_01",
            data: reportJson,
            dataType: "json",
            ...
            success: function (data) {
                if ('300' === data.statusCode || '301' === data.statusCode) {
                    alert(data.message);
                    $(".Mask").hide();
                    $(".ch-kp-fifty-one table:eq(1)").html('');
                    return true;
                }
                if (data.length == 0) {
                    ...
                    $.each(data, function (k, v) {
                        str += "<tr>"
                                    ...
                                    +"<td width='100px' class='xxbh'>"+v.xxbh+"</td>"
		                            +"<td width='140px' class='psjd'>"+v.psjd+"</td>"
		                            +"<td width='100px' class='cpsmjd'>"+v.cpsmjd+"</td>" 
		                            +"<td width='100px' class='jxdd'>"+v.jxdd+"</td>"
		                            +"<td width='80px' class='fxsj' >"+v.fxsj+"</td>"
		                            +"<td width='90px' class='cpxh'>"+v.cpxh+"</td>"
		                            +"<td width='110px' class='cpbh'>"+v.cpbh+"</td>"
		                            +"<td width='40px' class='amount'>"+v.amount+"</td>"
		                            +"<td width='100px' class='xzccrq'>"+v.xzccrq+"</td>"//新造出厂日期
		                            +"<td width='110px' class='zjjxccrq'>"+v.zjjxccrq+"</td>"
		                            +"<td width='140px' class='jcbh'>"+v.jcbh+"</td>"
		                            +"<td width='80px' class='zlc'>"+v.zlc+"</td>"
		                            +"<td width='80px' class='jxhlc'>"+v.jxhlc+"</td>"//检修后里程
		                            +"<td width='160px' class='gzbw'>"+v.gzbw+"</td>"
		                            +"<td width='420px' class='gzms'>"+v.gzms+"</td>"
                    ...
                    $(".ch-kp-fifty-one #t_r_content table").html(str);
                    trBg($(".ch-kp-fifty-one #t_r_content table"))
                }
                $(".Mask").hide();
                $(".sureBtns").click();
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (k, v) {
                            	str += "<tr>"
		                            ...
		                            +"<td width='110px' class='cpbh'>"+v.cpbh+"</td>"
		                            +"<td width='40px' class='amount'>"+v.amount+"</td>"
		                            +"<td width='100px' class='xzccrq'>"+v.xzccrq+"</td>"
		                            +"<td width='110px' class='zjjxccrq'>"+v.zjjxccrq+"</td>"
		                            +"<td width='140px' class='jcbh'>"+v.jcbh+"</td>"
		                            +"<td width='80px' class='zlc'>"+v.zlc+"</td>"
                            ...
                            item = item + 20;
                            $(".ch-kp-fifty-one table:eq(1)").append(str);
                            trBg($(".ch-kp-fifty-one table:eq(1)"));
                            $(".Mask").hide();
                            $(".sureBtns").click();
                            b = true;
                        },
