...
$(".ch-kp-fifty-two .t_r_content").height((heights -heights_f - 130) + "px");
//点击收起按钮
...
*/        	"lifnr":array13,//供应商
       ...
       $(".export").on("click", function () {
            ...
            downloadFile(reportJson, ctx + "/crrc/reportFS50/downloadFile_02");
        });
        $.ajax({
            url: ctx + "/crrc/reportFS50/result_02",
            data: reportJson,
            dataType: "json",
                ...
                if (data.length == 0) {
                    ...
                    $.each(data, function (k, v) {
                        str += "<tr>"
                                    ...
                                    +"<td width='120px' class='lbbh'>"+v.lbbh+"</td>"
		                            ...
		                            +"<td width='80px' class='jxdd'>"+v.jxdd+"</td>"
		                            ...
		                            +"<td width='80px' class='zrcp'>"+v.zrcp+"</td>"
                                    +"<td width='120px' class='yyfx'>"+v.yyfx+"</td>"
                                    +"<td width='280px' class='zgcs'>"+v.zgcs+"</td>"
