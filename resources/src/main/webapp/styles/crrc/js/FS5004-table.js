...
var search11=new multiSearch3($(".btn11"),"reportFS50/tvendor",null,null);//供应商
var search12=new multiSearch4($(".btn12"),"reportFS50/produccode",0,10);//产品编号
var search13=new multiSearch4($(".btn13"),"reportFS50/motorcode",0,10);//机车编号
var search14=new multiSearch4($(".btn14"),"reportFS50/losstypecode",0,10);//losstypecode  质量损失类别编号
var search15=new multiSearch4($(".btn15"),"reportFS50/reportcode",null,null);//reportcode报告编号
//控制表格高度的显示
var heights = $(window).height();
var heights_f=$(".container .col-sm-12 form").height();
$(".ch-kp-fifty-four .t_r_content").height((heights -heights_f - 140) + "px");
//点击收起按钮
$(".retract").off("click").on("click", function () {
    if ($(".container form").css("display") == "block") {
        ...
        $(this).text("展开  ∨");
        var heights = $(window).height();
        $(".ch-kp-fifty-four .t_r_content").animate({
...
$("#downMb").off("click").on("click", function () {
	...
	downloadFile(reportJson1,ctx + "/crrc/reportFS50/downloadTemplate");
});
//采购入库的表格
$("#submit").off("click").on("click", function () {
    ...
    $(".notSearch").empty();
    $("#show").text("数据正在加载中");
    var array1 = [], array2 = [], array3 = [],array4 = [],array5 = [],array6 = [],array7 = [],array8 = [],array9 = [],array10 = [],array11 = [],array12 = [],array13 = [],array14 = [],array15 = [];
    if ($(".xxbh").val() != "") {
   ...
   /* if ($(".jnjw").val() != "") {
    ...
    if ($(".lbbh").val() != "") {
        array14 = $(".lbbh").val().split(",");//质量损失类别编号
    }
    if ($(".bgbh").val() != "") {
        array15 = $(".bgbh").val().split(",");//报告编号
    }
    ...
    if(parseInt(txt1)>parseInt(txt2)||parseInt(txt3)>parseInt(txt4)){
        ...
        $(".export").on("click", function () {
            ...
            downloadFile(reportJson, ctx + "/crrc/reportFS50/downloadFile_04");
        });
        $.ajax({
            url: ctx + "/crrc/reportFS50/result_04",
            data: reportJson,
            dataType: "json",
            ...
            success: function (data) {
                if ('300' === data.statusCode || '301' === data.statusCode) {
                    alert(data.message);
                    $(".Mask").hide();
                    $(".ch-kp-fifty-four table:eq(1)").html('');
                    return true;
                }
                if (data.length == 0) {
                    ...
                    $.each(data, function (k, v) {
                        ...
                        str += "<tr>"
                                    ...
                                    +"<td width='120px' class='xxbh'>"+v.xxbh+"</td>"
                                    +"<td width='150px' class='lbbh'>"+v.lbbh+"</td>"
                                    +"<td width='110px' class='lbdm'>"+v.lbdm+"</td>"
                                    +"<td width='110px' class='yydm'>"+v.yydm+"</td>"
		                            +"<td width='150px' class='psjd'>"+v.psjd+"</td>"
		                            +"<td width='90px' class='cpsmjd'>"+v.cpsmjd+"</td>"
		                            +"<td width='100px' class='jxdd'>"+v.jxdd+"</td>"
		                            +"<td width='70px' class='fxsj' >"+v.fxsj+"</td>"
		                            +"<td width='60px' class='cpxh'>"+v.cpxh+"</td>"
		                            +"<td width='150px' class='cpbh'>"+v.cpbh+"</td>"
		                            +"<td width='50px' class='amount'>"+v.amount+"</td>"
		                            +"<td width='90px' class='xzccrq'>"+v.xzccrq+"</td>"
		                            +"<td width='110px' class='zjjxccrq'>"+v.zjjxccrq+"</td>"
		                            +"<td width='150px' class='jcbh'>"+v.jcbh+"</td>"
		                            +"<td width='80px' class='zlc'>"+v.zlc+"</td>"
		                            +"<td width='80px' class='jxhlc'>"+v.jxhlc+"</td>"
		                            +"<td width='150px' class='gzbw'>"+v.gzbw+"</td>"
		                            +"<td width='350px' class='gzms'>"+v.gzms+"</td>"
		                            +"<td width='200px' class='cljg'>"+v.cljg+"</td>"
		                            +"<td width='60px' class='clff'>"+v.clff+"</td>"
		                            +"<td width='140px' class='gzwcrq'>"+v.gzwcrq+"</td>"
		                            +"<td width='60px' class='sglb'>"+v.sglb+"</td>"
		                            +"<td width='60px' class='yzd'>"+v.yzd+"</td>"
		                            +"<td width='60px' class='zrcp'>"+v.zrcp+"</td>"
                                    +"<td width='180px' class='yyfx'>"+v.yyfx+"</td>"
                                    +"<td width='250px' class='zgcs'>"+v.zgcs+"</td>"
                                    +"<td width='110px' class='bgbh'>"+v.bgbh+"</td>"
                                    +"<td width='150px' class='zrdw'>"+v.zrdw+"</td>"
                                    ...
                                    +"<td width='80px' class='jnw'>"+v.jnw+"</td>"
		                            +"<td width='80px' class='xzjx'>"+v.xzjx+"</td>"
                                    +"<td width='80px' class='cpfl'>"+v.cpfl+"</td>"
                                    +"<td width='80px' class='gzlx'>"+v.gzlx+"</td>"
                                    +"<td width='280px' class='gdpc'>"+v.sf+"</td>"
                                    +"<td width='110px' class='spjz'>"+v.spqk+"</td>"
                                    +"<td width='150px' class='fx'>"+v.fx+"</td>"
                                    +"<td width='60px' class='cgy'>"+v.cgy+"</td>"
                                    +"<td width='80px' class='gys'>"+v.lifnr+"</td>"
                                   /* +"<td width='80px' class='cnw'>"+v.cnw+"</td>"*/
                                    +"<td class='bz'>"+v.bz+"</td>"
                                + "</tr>";
                    });
                    $(".ch-kp-fifty-four table:eq(1)").html(str);
                    trBg($(".ch-kp-fifty-four table:eq(1)"))
                }
                $(".Mask").hide();
                $(".sureBtns").click();
            },
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (k, v) {
                            	str += "<tr>"
		                        	...
		                        	/*+"<td width='70px' class='rq'>"+ v.date+"</td>"*/
                                    +"<td width='60px' class='yf'>"+v.month+"</td>"
                                    +"<td width='120px' class='xxbh'>"+v.xxbh+"</td>"
                                    +"<td width='150px' class='lbbh'>"+v.lbbh+"</td>"
                                    +"<td width='110px' class='lbdm'>"+v.lbdm+"</td>"
                            ...
                            item = item + 20;
                            $(".ch-kp-fifty-four table:eq(1)").append(str);
                            trBg($(".ch-kp-fifty-four table:eq(1)"));
                            $(".Mask").hide();
                            $(".sureBtns").click();
                            b = true;
