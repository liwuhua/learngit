...
var DWZ={	keyCode : {
	...
	ajaxDone : function(json) {
		if (json.statusCode == DWZ.statusCode.error) {
			...
			if (alertMsg)
				alertMsg.error(json.message || DWZ.msg("forbidden"));
			else
				DWZ.loadLogin();
		} else {
			if (json.message && alertMsg)
	...
	$a
			.each(function() {
				...
				if ($span.length == 0) {
					$(this)
							.css({
										"background" : "url(../styles/dwz/themes/css/images/toolbar_icons16/"
												+ imageName + ".png) no-repeat",
					...
					$span.css({
								"background-image" : "url(../styles/dwz/themes/css/images/toolbar_icons16/"
										+ imageName + ".png)",
...
function navTabSearch(form, navTabId) {
	...
	if (form[DWZ.pageInfo.numPerPage])
		form[DWZ.pageInfo.numPerPage].value = 15;
