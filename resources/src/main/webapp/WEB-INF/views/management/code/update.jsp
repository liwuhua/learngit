...
<div class="pageContent">
	<form method="post" action="${contextPath }/management/code/updateCode"
		...
		<div class="pageFormContent" layoutH="58">
			...
			<p class="nowrap">
				<label>编码类型ID ：</label> <input type="text" name="codeTypeId"
					style="width: 545px;" value="${codeInfo.codeTypeId }"
					readonly="readonly" />
			</p>
			<%-- <p class="nowrap">
			...
			<p class="nowrap">
				<label>二级编码：</label> <input type="text" name="code2"
					...
					class="validate[required,minSize[2],maxSize[2]] required" size="20" maxlength="32" />
			</p>
			<p class="nowrap">
			...
			<p class="nowrap">
				<label>编码：</label> <input type="text" name="code4"
					style="width: 545px;" value="${codeInfo.code4 }"  readonly="readonly"/>
			</p>
			<p class="nowrap">
