...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!--<script src="${contextPath}/styles/jquery/ichart.1.2.min.js" type="text/javascript"></script>  -->
        <script src="${contextPath}/styles/chart/chart.js" type="text/javascript"></script>
        ...
        <script src="${contextPath}/styles/chart/moment.js" type="text/javascript"></script>
        <script src="${contextPath}/styles/chart/calctime.js" type="text/javascript"></script>
        <script src="${contextPath}/styles/My97DatePicker/WdatePicker.js" type="text/javascript"></script>
        <%-- colorPicker --%>
        <script src="${contextPath}\styles\ColorPicker\jquery.colorpicker.js" type="text/javascript"></script>
    ...
    <body scroll="no">
            ...
            <div id="header">
                <div class="headerNav">
                    <ul class="nav">
                        ...
                        <c:if test="${empty isCodeManager and empty isUserWithCodeManage}">
        ...
        <div id="footer">中国中车股份有限公司 版权所有 2016 京ICP备15050284号 京公安网安备11010802020546号</div>
    </body>
</html>