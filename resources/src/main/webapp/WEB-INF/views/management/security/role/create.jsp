<%@page import="com.yjdj.view.core.entity.Permission"%>
<%@page import="com.yjdj.view.core.entity.Module"%>
...
<form onsubmit="return validateCallback(this, navTabAjaxDone);" class="required-validate pageForm" action="${contextPath }/management/security/role/create" method="post">
