...
<head>
    ...
    <title>DPI</title>
    <link href="${contextPath}/styles/crrc/css/FS5003.css" rel="stylesheet" type="text/css" />
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
        var plant = "${plant}";
...
<body class="fixed-left">
            ...
            <div class="content">
                <div class="container">
                        ...
                        <div class="col-sm-12">
                            <form>
                                <p>
                                    ...
                                    <span><b class="type">质量损失类别编号</b><input class="zlsslbbh" type="text"><span class="btn12 btnAll"></span></span>
                                    <span><b class="type">产品编号</b><input class="cpbh" type="text"><span class="btn13 btnAll"></span></span>
                                    <span><b class="type">机车编号</b><input class="jcbh" type="text"><span class="btn14 btnAll"></span></span>
                    ...
                    <div class="row" style="position:relative;">
                        <p class="table-name">厂外铁路产品质量信息表-质保部</p>
                        <p class="table-data"><span>货币单位:   元</span><b class="fr"><img alt="" title="下载" src="${contextPath}/styles/common/images/right/export.png" class="export"><img title="隐藏列" alt="" src="${contextPath}/styles/common/images/right/hide.png" class="hideCol"></b></p>
                        <div class="t_r ch-kp-fifty-three">
                                ...
                                <div class="t_r_title">
                                    <table class="col-sm-12">
                                        <tr>
                                            ...
                                            <th width='110px' class='xxbh'>信息编号</th>
                                            <th width='120px' class='sslbbh'>质量损失类别编号</th>
                                            <th width='110px' class='sslbdm'>质量损失类别</th>
                                            <th width='110px' class='ssyydm'>质量损失原因</th>
                                            <th width='140px' class='psjd'>配属局段</th>
                                            <th width='90px' class='cpsmjd'>产品寿命阶段</th> 
                                            <th width='90px' class='jxdd'>检修地点</th>
                                            ...
                                            <th width='140px' class='gzbw'>故障部位</th>
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS5003-table.js"></script>
</body>
</html>
