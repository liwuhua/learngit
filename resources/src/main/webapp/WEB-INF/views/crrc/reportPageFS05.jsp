...
<head>
    ...
    <title>DPI</title>
    <link rel="stylesheet" href="${contextPath}/styles/crrc/css/FS05.css">
    <style>
    	.ch-kp-five th{
    		font-size:16px;
    		font-weight:400;
...
<body class="fixed-left">
            ...
            <div class="content-page">
                <div class="content">
                    <div class="container">
                        ...
                        <div class="row ch-kp-five">
                        	<p class="table-name">应上交应弥补款项表</p>
	                        <p class="table-data"><b class="fl">编制单位：<strong class="bianzhi"></strong><b style="margin-left:20px;">货币单位: 元</b></b><span class="fr"><span class="datatime1"></span><img alt="" title="下载" src="${contextPath}/styles/common/images/right/export.png" class="export"><img alt="" title="上传" src="${contextPath}/styles/common/images/right/import.png" class="import"></span></p>
                        	<div class="t_r table-five">
                    	...
                    	<div class="importBox">
	                        ...
	                        <div style="width:100%;">
	                            <div class="chooseFile">
	                                ...
	                                <input id="fileupload" type="file" name="files[]" multiple data-url="${contextPath}/crrc/reportFS05/uploadFile" data-sequential-uploads="true" data-form-data='{"script": "true"}' accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" />
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS05-table.js"></script>
