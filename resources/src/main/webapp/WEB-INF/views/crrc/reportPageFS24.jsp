...
<head>
    ...
    <title>DPI</title>
    <link href="${contextPath}/styles/crrc/css/FS24.css" rel="stylesheet" type="text/css" />
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
    ...
    <div id="wrapper">
        ...
        <div class="content">
            <div class="container">
                ...
                <!-- //表格显示 -->
                <div class="row">
                    <p class="table-name">制造费用统计分析表</p>
                ...
                <div class="importBox">
                    ...
                    <div style="width:100%;">
                        <div class="chooseFile">
                            ...
                            <input id="fileupload" type="file" name="files[]" multiple data-url="${contextPath}/crrc/reportFS24/uploadFile" data-sequential-uploads="true" data-form-data='{"script": "true"}' accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" />
...
<script type="text/javascript" src="${contextPath}/styles/crrc/js/FS24-table.js"></script>
</body>
</html>
