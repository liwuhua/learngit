...
<head>
    ...
    <title>DPI</title>
    <link rel="stylesheet" href="${contextPath}/styles/crrc/css/FS17.css">
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
    </script>
...
<body class="fixed-left">
        ...
        <div class="content-page">
            <div class="content">
                <div class="container">
                    ...
                    <div class="row ch-kp-seventeen">
                        <p class="table-name">现金流量表(合并)</p>
                        <p class="table-data">
                        ...
                        <div class="seventeen" style="overflow: hidden;">
                            <div  class="div-table">
                                <div class="t_r">
                                    <div class="t_r_t" id="t_r_t">
                                        <div class="t_r_title">
                                            <table>
                                                <tr>
                                                    <!-- <th width='365px'>项目</th>
                                                    <th width='40px' class="xh">行次</th>
                                                    <th width='110px' style="text-align:right;">本期金额</th>
                                                    <th width='110px' style="text-align:right;">上期金额</th>
                                                    <th width='365px'>项目</th>
                                                    <th width='40px' class="xh">行次</th>
                                                    <th width='110px' style="text-align:right;">本期金额</th>
                                                    <th style="text-align:right;padding-right:17px;">上期金额</th> -->
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
                    ...
                    <div class="importBox">
                        ...
                        <div style="width:100%;">
                            <div class="chooseFile">
                                ...
                                <input id="fileupload" type="file" name="files[]" multiple data-url="${contextPath}/crrc/reportFS17/uploadFile" data-sequential-uploads="true" data-form-data='{"script": "true"}' accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" />
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS17-table.js"></script>
