...
<head>
    ...
    <title>DPI</title>
    <link rel="stylesheet" href="${contextPath}/styles/crrc/css/FS59.css">
...
<body class="fixed-left">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
	                        ...
	                        <p class="table-data" id="table-data">
                                ...
                                <span class="fr"><img alt="" title="下载" src="${contextPath}/styles/common/images/right/export.png" class="export"></span>
                            </p>
	                        <div class="ch-kp-fiftyNine" id="ch-kp-fiftyNine">
                                <div class="t_r_t" id="t_r_t">
                                    <div class="t_r_title">
                                        <table class="col-sm-12" width="100%">
                                            <tr>
                                                <th width='200px'>项目</th>
                                                <th width='40px' class="xh">栏次</th>
                                                <th width='150px'>本年累计发生额</th>
   ...
   <script src="${contextPath}/styles/common/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS59-table.js"></script>
