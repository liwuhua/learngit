...
<head>
    ...
    <title>DPI</title>
    <link rel="stylesheet" href="${contextPath}/styles/crrc/css/FS54.css">
    <script>
        var ctx = "${ctx}";
        var plant = "${plant}";/*  工厂 --> */
...
<body class="fixed-left">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <form>
                                    <p>
                                    	<span><b class="type">产品型号</b><input class="cpxh" type="text"><span class="btn1 btnAll"></span></span>
	                                    <span style='display:none;'><b class="type">配件名称</b><input class="pjmc" type="text"><span class="btn2 btnAll"></span></span>
	                                    <span><b class="type">物料编码（必填）</b><input class="material" type="text"><span class="btn3 btnAll"></span></span>
	                                    <span><b class="type">使用车型</b><input class="sycx" type="text"><span class="btn4 btnAll"></span></span>
	                                    <span><b class="type">服务站</b><input class="fwz" type="text"><span class="btn5 btnAll"></span></span>
	                                    <span><b class="type">服务点</b><input class="fwd" type="text"><span class="btn6 btnAll"></span></span>
										<span>
											<b>年月（必填）</b><input type="text" id="searchTime" class='searchTime' onclick="WdatePicker({dateFmt: 'yyyy-MM'})" onfocus="this.blur()">
										</span>
	                                    <span><input id="resetBtn" type="reset" value="重置"><input type="button" value="提交" id="submit">
	                                    <input type="button" value="上传" class='import' style="width: 40px; background: #c70019;color:#fff;">
	                                    <%-- <img title="上传" alt="" src="${contextPath}/styles/common/images/right/import.png" class="import"> --%>
	                                    		<!-- <input type="button" value="下载模版" id="downMb" style="width: 60px; background: #c70019;">
	                                    		<input type="button" value="上传模板" id="upMb" style="width: 60px; background: #c70019;"> -->
	                                    </span>
                                    </p>
                                </form>
                        ...
                        <div class="row">
                        	...
                        	<p class="table-data"><span class="dataTime1"></span><img title="下载" alt="" src="${contextPath}/styles/common/images/right/export.png" class="export"></p>
                        	<div class="t_r  ch-kp-fiftyFour">
                        ...
                        <div class="importBox">
                            ...
                            <div style="width:100%;">
                                <div class="chooseFile">
                                    ...
                                    <input id="fileupload" type="file" name="files[]" multiple data-url="${contextPath}/crrc/reportFS54/uploadFile" data-sequential-uploads="true" data-form-data='{"script": "true"}' accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" />
    ...
    <script src="${contextPath}/styles/crrc/js/FS54-table.js"></script>
    <!--DatePicker-->
