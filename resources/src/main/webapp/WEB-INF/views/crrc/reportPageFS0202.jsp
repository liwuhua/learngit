...
<body class="fixed-left">
            ...
            <div class="content-page">
                <div class="content">
                    <div class="container">
                            ...
                            <div class="col-sm-12">
                                <form>
                                    <p>
	                                    ...
	                                    <span class="setTime">
	                                    	<b>下周/月交付日期(必填)</b><input type="text" id="startTimeTwo" class="startTimeTwo" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  onfocus="this.blur()"> - <input type="text" id="endTimeTwo" class="endTimeTwo" onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})"  onfocus="this.blur()">
	                                    </span>
                        ...
                        <div class="row">
                        	<p class="table-name">销售订单需求统计表</p>
                        	<p class="table-data"><span class="dataTime2"></span><c:if test="${showExp eq 1}"><img title="下载" alt="" src="${contextPath}/styles/common/images/right/export.png" class="export"></c:if><img title="隐藏列" alt="" src="${contextPath}/styles/common/images/right/hide.png" class="hideCol"></p>
                        	<div class="t_r  ch-kp-cb2">
                        		<div class="t_r_t" id="t_r_t2">
	                     		...
	                     		<div class="t_r_content" id="t_r_content2" onscroll="bb()">
	                             	...
	                             	<div id='show2' style="width:100%;text-align:center;">信息正在加载中。。。</div>
	                             </div>
	                             <div class="toTop"></div>
                        	</div>
                        </div>
    ...
    <script src="${contextPath}/styles/crrc/js/FS0202-table.js"></script>
    <!--DatePicker-->
