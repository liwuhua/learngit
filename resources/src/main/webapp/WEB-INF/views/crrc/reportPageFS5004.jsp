...
<head>
    ...
    <title>DPI</title>
    <link href="${contextPath}/styles/crrc/css/FS5004.css" rel="stylesheet" type="text/css" />
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
        var plant = "${plant}";
...
<body class="fixed-left">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div class="row" style="position:relative;">
                        <p class="table-name">厂外铁路产品质量信息表-数据导入</p>
                        ...
                        <div class="t_r ch-kp-fifty-four">
                            <div class="t_r_t" id="t_r_t">
                                <div class="t_r_title">
                                    <table class="col-sm-12">
                                        <tr>
                                        	<th width='40px' class='xh'>序号</th>
                                            <!-- <th width='70px' class='rq'>日期</th> -->
                                            <th width='60px' class='yf'>月份</th>
                                            <th width='120px' class='xxbh'>信息编号</th>
                                            <th width='150px' class='lbbh'>质量损失类别编号</th>
                                            <th width='110px' class='lbdm'>质量损失类别</th>
                                            <th width='110px' class='yydm'>质量损失原因</th>
                                            <th width='150px' class='psjd'>配属局段</th>
                                            <th width='90px' class='cpsmjd'>产品寿命阶段</th>
                                            <th width='100px' class='jxdd'>检修地点</th>
                                            <th width='70px' class='fxsj' >发现时间</th>
                                            <th width='60px' class='cpxh'>产品型号</th>
                                            <th width='150px' class='cpbh'>产品编号</th>
                                            <th width='50px' class='amount'>数量</th>
                                            <th width='90px' class='xzccrq'>新造出厂日期</th>
                                            <th width='110px' class='zjjxccrq'>最近检修出厂日期</th>
                                            <th width='150px' class='jcbh'>机车编号</th>
                                            <th width='80px' class='zlc'>总运行里程</th>
                                            <th width='80px' class='jxhlc'>检修后里程</th>
                                            <th width='150px' class='gzbw'>故障部位</th>
                                            <th width='350px' class='gzms'>故障描述</th>
                                            <th width='200px' class='cljg'>处理结果</th>
                                            <th width='60px' class='clff'>处理方法</th>
                                            <th width='140px' class='gzwcrq'>现场故障处理完成日期</th>
                                            <th width='60px' class='sglb'>事故类别</th>
                                            <th width='60px' class='yzd'>严重度</th>
                                            <th width='60px' class='zrcp'>责任初判</th>
                                            <th width='180px' class='yyfx'>原因分析</th>
                                            <th width='250px' class='zgcs'>整改措施</th>
                                            <th width='110px' class='bgbh'>报告编号</th>
                                            <th width='150px' class='zrdw'>责任单位</th>
                                            ...
                                            <th width='80px' class='jnw'>境内/境外</th>
                                            <th width='80px' class='xzjx'>新造/检修</th>
                                            <th width='80px' class='cpfl'>产品分类</th>
                                            <th width='80px' class='gzlx'>故障类型</th>
                                            <th width='280px' class='gdpc'>合同是否规定赔偿金额、时间和付款方式（是/否)</th>
                                            <th width='110px' class='spjz'>索赔进展情况</th>
                                            <th width='150px' class='fx'>分析</th>
                                            <th width='60px' class='cgy'>采购员</th>
                                            <th width='80px' class='gys'>供应商</th>
                                            <!-- <th width='80px' class='cnw'>厂内、厂外</th> -->
                                            <th class='bz'>备注</th>
                                        </tr>
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS5004-table.js"></script>
</body>
</html>
