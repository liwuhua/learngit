...
<head>
    ...
    <title>DPI</title>
    <link href="${contextPath}/styles/crrc/css/FS28.css" rel="stylesheet" type="text/css" />
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
    ...
    <div class="content-page">
        <div class="content">
            <div class="container">
                ...
                <!-- //表格显示 -->
                <div class="row">
                    <p class="table-name">管理费用统计分析表</p>
                ...
                <div class="importBox">
                    ...
                    <div style="width:100%;">
                        <div class="chooseFile">
                            ...
                            <input id="fileupload" type="file" name="files[]" multiple data-url="${contextPath}/crrc/reportFS28/uploadFile" data-sequential-uploads="true" data-form-data='{"script": "true"}' accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/vnd.ms-excel" />
...
<script type="text/javascript" src="${contextPath}/styles/crrc/js/FS28-table.js"></script>
</body>
</html>
