...
<body class="fixed-left">
                        ...
                        <div class="col-sm-12">
                            <form>
                                <p>
                                    ...
                                    <span class="setTime">
                                        <b>报告日期（必填）</b><input type="text" id="startTime" class="startTime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd'})" onfocus="this.blur()"> - <input type="text" id="endTime" class="endTime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd'})" onfocus="this.blur()">
                                    </span>
                                ...
                                <div class="t_r_title">
                                    <table class="col-sm-12">
                                        <tr>
                                            ...
                                            <th width='130px' class='LACK_ORDERNUM'>缺件订单数</th>
                                            <th width='130px' class='SUM_AUFNR'>总订单数</th>
                                            <th class='RATE'>订单齐套率</th>
                                        </tr>
                                    </table>
                                </div>
                            </div>
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS45-table.js"></script>
</body>
</html>
