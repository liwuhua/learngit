...
<head>
    ...
    <title>DPI</title>
    <link href="${contextPath}/styles/crrc/css/FS51.css" rel="stylesheet" type="text/css" />
    <script>
        var ctx = "${contextPath}";
        var url = "${url}";
    </script>
...
<body class="fixed-left">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <form>
                                <p>
                                    <span><b class="type">产品型号</b><input class="productModel" type="text"><span class="btn1 btnAll"></span></span>
                    ...
                    <div class="row" style="position:relative;">
                        <p class="table-name">电机型号检索故障信息表</p>
                        <p class="table-data"><span class="fr"><img alt="" title="下载" src="${contextPath}/styles/common/images/right/export.png" class="export"></span></p>
                        <div class="ch-kp-51">
    ...
    <script type="text/javascript" src="${contextPath}/styles/crrc/js/FS51-table.js"></script>
</body>
</html>
